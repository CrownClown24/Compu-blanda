...
import numpy as np
# Se crea una array con 8 elementos
a = np.arange(8)
...
# Crea un array con 10 elementos, desde 0 hasta 9
a = np.arange(10)
print('a =', a, '\n')
...
print('b =\n', b, '\n')
# La instrucción reshape genera una matriz con 2 bloques, 5 filas y 4 columnas
# El número total de elementos es de 40 (generados por arange)
...
# Transformamos la matriz en 10 filas x 4 columnas
b.shape = (10,4)
print('b(6x4) =\n', b)
